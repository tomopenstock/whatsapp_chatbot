...
with open("/Users/openstockltd/Documents/Chatbot/V2/Preprocessing V2/olivia_information.json") as f:
    data = json.load(f)

    

embedding_model = data['hyperparams']['embedding_model']
...
embedding_human_escalation = client.embeddings.create(input=human_escalation_df["information_en"].tolist(), model=embedding_model)
...
with open("/Users/openstockltd/Documents/Chatbot/V2/Preprocessing V2/olivia_information_vectors.json", "w") as f:
